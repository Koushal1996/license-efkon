...
public interface UserService {
     ...
     * @param roleId
     * @return list of <tt>UserResponse</tt>
     * @throws NotFoundException if role id not found
     */
     ...
     * @return {@link UserResponse}
     * @throws NotFoundException   if user not found
     * @throws ValidationException if request body aren't valid like email or contact number or
     ...
     * @throws ValidationException if username pattern didn't match or email or contact not
     *                             registered with us
     ...
     * @return <tt>SuccessResponse</tt> - success message
     * @throws ValidationException if generated password didn't match
     * @throws NotFoundException   if username not found
     */
     ...
     *
     * @param request - key value pair of generated password and username
     * @return <tt>SuccessResponse</tt> - success message
     * @throws ValidationException if generated password didn't match
     */
